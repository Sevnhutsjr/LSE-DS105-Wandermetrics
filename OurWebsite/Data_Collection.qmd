...
<p style='text-align:center'>
    <img src="figures/distribution.png" width="960" height="540" />
</p>
...
|                      Athens                       |                      Berlin                       |
|:------------------------------------------------:|:------------------------------------------------:|
| ![Athens](figures/distribution_Athens.png)        | ![Berlin](figures/distribution_Berlin.png)        |

|                     Budapest                      |                      Lisbon                       |
|:------------------------------------------------:|:------------------------------------------------:|
| ![Budapest](figures/distribution_Budapest.png)    | ![Lisbon](figures/distribution_Lisbon.png)        |

|                      Madrid                       |                      Paris                        |
|:------------------------------------------------:|:------------------------------------------------:|
| ![Madrid](figures/distribution_Madrid.png)        | ![Paris](figures/distribution_Paris.png)          |

|                       Rome                        |                                                   |
|:------------------------------------------------:|--------------------------------------------------|
| ![Rome](figures/distribution_Rome.png)            |                                                  |
...
<p style='text-align:center'>
    <img src="figures/outliers_month.png" width="700" height="1000" />
</p>
...
<p style='text-align:center'>
    <img src="figures/outliers_carrier.png" width="700" height="1000" />
</p>
...
<p style='text-align:center'>
    <img src="figures/outliers_airport.png" width="700" height="1000" />
</p>
